...
import { Zap, Star, Users, Clock, ChevronDown, ArrowRight } from "lucide-react";
...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden" onMouseMove={handleMouseMove}>
      ...
      {/* Mouse-tracking animated gradient orbs */}
      <motion.div
        className="absolute w-96 h-96 bg-orange-500/20 rounded-full blur-3xl pointer-events-none"
        animate={{
      ...
      />
      <motion.div
        className="absolute w-80 h-80 bg-purple-500/20 rounded-full blur-3xl pointer-events-none"
        animate={{
          x: mousePosition.x * 1.5 - 50,
          y: mousePosition.y * 1.5 - 50,
        }}
        ...
        <div className="text-center max-w-6xl mx-auto w-full">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-1.5 sm:gap-2 bg-gradient-to-r from-orange-500 to-red-600 text-white px-3 py-1.5 sm:px-4 sm:py-2 rounded-full text-xs sm:text-sm font-semibold mb-4 sm:mb-6"
            >
            ...
            <motion.h1
              ...
              className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-2 sm:mb-3 md:mb-4 tracking-tight leading-tight"
            >
              <span className="text-white">INNOVATE</span>{" "}
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="group relative w-full max-w-xs sm:max-w-sm px-6 sm:px-8 py-3 sm:py-4 border-2 border-orange-400/50 text-white font-semibold text-base sm:text-xl md:text-2xl lg:text-3xl rounded-full backdrop-blur-sm bg-orange-400/5 hover:bg-orange-400/10 hover:border-orange-400 transition-all duration-300"
              onClick={handleNavigate}
            >
              <span className="flex items-center justify-center gap-2 sm:gap-4">
                <Zap className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 group-hover:scale-110 transition-transform duration-300" />
                <span>Get a Quote</span>
              </span>
            </motion.button>
          </motion.div>

          {/* Trust Indicators - Better mobile layout with Lucide icons */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="flex flex-col gap-3 sm:flex-row sm:gap-6 md:gap-8 items-center justify-center text-xs sm:text-sm text-slate-400">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs sm:text-sm">2 Week Delivery</span>
              </div>
            </div>
          </motion.div>

          {/* Scroll Indicator - Hidden on mobile with Lucide icon */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
