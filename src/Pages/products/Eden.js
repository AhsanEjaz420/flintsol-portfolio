...
const Eden = () => {
  ...
  // Editorial Theme - Light Mode with Gold Accents
  const theme = {
    primary: '#f8a201',      // Editorial Gold
    background: '#FFFFFF',   // Pure White
    surface: '#F8FAFC',      // Light Gray Surface
    surfaceAlt: '#F1F5F9',   // Alternate Light Surface
    text: '#121D1A',         // Dark Text
    muted: '#58565677',        // Dark Gray
  ...
  return (
    <div className="min-h-screen bg-[#FFFFFF] text-[#121D1A] font-sans relative overflow-x-hidden selection:bg-[#C5A059]/20">
      ...
      {/* Navigation */}
      <nav className="fixed top-0 w-full z-50 bg-[#FFFFFF]/90 backdrop-blur-md border-b border-[#C5A059]/10">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 h-20 flex items-center justify-between">
          ...
          >
            <Link to="/Portfolio" className="flex items-center gap-2 group">
              ...
              <span className="text-xs font-semibold tracking-widest uppercase text-gray-500 group-hover:text-[#121D1A] transition-colors">Back to Portfolio</span>
            </Link>
          </motion.div>
          ...
          <div className="hidden md:flex gap-8 lg:gap-12 text-[10px] uppercase tracking-[0.2em] font-medium">
            <a href="#features" className="text-gray-500 hover:text-[#C5A059] transition-all">Features</a>
            <a href="#models" className="text-gray-500 hover:text-[#C5A059] transition-all">Models</a>
            <a href="#technology" className="text-gray-500 hover:text-[#C5A059] transition-all">Technology</a>
          </div>

          <button
            className="md:hidden text-[#121D1A]"
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="fixed inset-0 z-40 bg-[#FFFFFF] flex flex-col items-center justify-center gap-8 md:hidden pt-20"
          >
            <a href="#features" onClick={() => setIsMenuOpen(false)} className="text-[#C5A059] text-lg font-bold uppercase tracking-widest">Features</a>
            <a href="#models" onClick={() => setIsMenuOpen(false)} className="text-gray-500 text-lg font-bold uppercase tracking-widest hover:text-[#121D1A] transition-opacity">Models</a>
            <a href="#technology" onClick={() => setIsMenuOpen(false)} className="text-gray-500 text-lg font-bold uppercase tracking-widest hover:text-[#121D1A] transition-opacity">Technology</a>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <main className="relative z-10">
        ...
        >
          <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-12 items-center">
            ...
            >
              ...
              <h1 className="font-serif text-5xl md:text-7xl lg:text-[90px] font-light leading-[0.9] tracking-tighter italic mb-8 lg:mb-10 text-[#121D1A]">
                Creative<br/><span className="not-italic font-bold text-6xl md:text-8xl lg:text-[100px] text-[#121D1A]">Intelligence</span>
              </h1>
              <div className="w-16 h-1 bg-[#C5A059] mb-8 lg:mb-10"></div>
              <p className="text-sm lg:text-base leading-relaxed text-gray-600 max-w-md mb-10 lg:mb-12">
            ...
            >
              <div className="relative w-full h-[400px] md:h-[500px] lg:h-[600px] flex items-center justify-center">
                <div className="absolute w-[280px] md:w-[350px] lg:w-[400px] h-[380px] md:h-[470px] lg:h-[540px] bg-[#F1F5F9] border border-[#C5A059]/10 rounded-[20px] transform rotate-3"></div>
                <div className="absolute w-[280px] md:w-[350px] lg:w-[400px] h-[380px] md:h-[470px] lg:h-[540px] bg-[#FFFFFF] border border-[#C5A059]/20 rounded-[20px] transform -rotate-6 flex flex-col items-center justify-center overflow-hidden p-6 lg:p-8 shadow-lg">
                  {/* Image Placeholder */}
                  <div className="w-full h-full flex flex-col items-center justify-center bg-[#F8FAFC] rounded-[12px] border border-dashed border-[#C5A059]/20">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-[#FFFFFF] to-transparent pointer-events-none"></div>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-baseline mb-16 lg:mb-24">
              <div>
                ...
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter text-[#121D1A]">Capabilities</h2>
              </div>
              <div className="text-4xl md:text-5xl lg:text-[48px] font-serif italic font-light opacity-10 mt-4 md:mt-0 text-[#C5A059]">02</div>
            </div>

            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 overflow-hidden">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  whileHover={{ backgroundColor: "rgba(197, 160, 89, 0.08)" }}
                  className={`bg-white border border-[#C5A059]/10 p-8 lg:p-12 transition-colors duration-500 min-h-[350px] lg:min-h-[400px] flex flex-col justify-between group shadow-sm ${feature.size === 'col-span-2' ? 'md:col-span-2' : ''}`}
                >
                  <div>
                    <feature.icon className="text-[#C5A059] mb-6 lg:mb-8 opacity-40 group-hover:opacity-100 transition-opacity" size={28} />
                    <h3 className="text-xl lg:text-2xl font-bold mb-4 lg:mb-6 text-[#121D1A] leading-tight uppercase tracking-wide">
                      {feature.title}
                    </h3>
                    <p className="text-gray-600 leading-relaxed text-sm lg:text-base max-w-xs">
                      {feature.description}
                    </p>
                  </div>
        ...
        >
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6 lg:gap-12 mb-12 lg:mb-24">
              ...
              <span className="text-[10px] uppercase tracking-[0.2em] text-gray-500">25+ Provider Synergies</span>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 lg:gap-8">
              {models.map((model, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  whileHover={{ y: -5 }}
                  className="p-6 lg:p-8 border border-[#C5A059]/10 bg-[#F8FAFC] text-center relative group shadow-sm"
                >
                  <div className="absolute inset-0 border border-[#C5A059]/0 group-hover:border-[#C5A059]/30 transition-all pointer-events-none"></div>
                  <model.icon className="text-[#C5A059] mx-auto mb-4 lg:mb-6 opacity-30 group-hover:opacity-100 transition-opacity" size={24} />
                  <h4 className="text-[#121D1A] font-bold text-sm mb-2">{model.name}</h4>
        ...
        >
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl lg:text-7xl font-bold tracking-tighter mb-8 lg:mb-12 text-[#121D1A]">Technical<br/><span className="italic font-light font-serif text-[#121D1A]">Architecture</span></h2>
              <p className="text-gray-600 leading-relaxed max-w-sm mb-8 lg:mb-12 text-sm lg:text-base">
              ...
              <div className="flex gap-12 lg:gap-16">
                <div>
                  ...
                  <div className="text-xs font-mono text-[#121D1A]">OPTIMAL // 0.002ms</div>
                </div>
                <div>
                  <div className="text-[9px] uppercase tracking-[0.15em] text-gray-500 mb-2">Uptime</div>
                  <div className="text-xs font-mono text-[#121D1A]">99.982% SYNCED</div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-10 lg:space-y-12 mt-8 lg:mt-0">
              {techStack.map((stack, idx) => (
                ...
                >
                  ...
                  <h3 className="text-lg lg:text-xl font-bold text-[#121D1A] mb-4 lg:mb-6 uppercase tracking-widest flex items-center gap-3 lg:gap-4">
                    <span className="text-[#C5A059] opacity-50">{idx + 1}.</span>
                    {stack.category}
                  </h3>
                  <ul className="grid grid-cols-2 gap-3 lg:gap-4">
                    {stack.items.map((item, i) => (
                      <li key={i} className="text-[10px] lg:text-[11px] uppercase tracking-widest text-gray-600 flex items-center gap-2 lg:gap-3">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 lg:mb-20 gap-6">
              <div>
                ...
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter text-[#121D1A]">Platform Gallery</h2>
              </div>
              <p className="text-sm text-gray-600 max-w-xs">Interface previews and system screenshots. Assets loading.</p>
            </div>
            ...
            <div className="grid md:grid-cols-12 gap-4 lg:gap-8 h-auto md:h-[600px] lg:h-[800px]">
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="md:col-span-8 rounded-[24px] lg:rounded-[40px] overflow-hidden border border-dashed border-[#C5A059]/20 bg-[#F8FAFC] flex items-center justify-center min-h-[300px] md:min-h-0 shadow-sm"
              >
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="md:col-span-4 rounded-[24px] lg:rounded-[40px] overflow-hidden border border-dashed border-[#C5A059]/20 bg-[#F8FAFC] flex items-center justify-center min-h-[300px] md:min-h-0 shadow-sm"
              >
                <div className="text-center">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="md:col-span-6 rounded-[24px] lg:rounded-[40px] overflow-hidden border border-dashed border-[#C5A059]/20 bg-[#F8FAFC] flex items-center justify-center min-h-[300px] md:min-h-0 shadow-sm"
              >
                <div className="text-center">
        ...
        >
          <motion.div
            ...
            viewport={{ once: true }}
            className="max-w-7xl mx-auto border border-[#C5A059]/10 bg-[#F8FAFC] relative overflow-hidden p-12 lg:p-24 text-center rounded-[2rem] lg:rounded-[3rem] shadow-lg"
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter mb-8 lg:mb-12 text-[#121D1A]">Ready to Initialize?</h2>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6 lg:gap-12 items-center">
              ...
              <button className="text-[10px] uppercase tracking-[0.2em] text-gray-500 hover:text-[#C5A059] transition-all font-bold">
                View Pricing
              </button>
            </div>
          </motion.div>
      ...
      {/* Footer */}
      <footer className="px-6 lg:px-12 pb-12 lg:pb-20 pt-12 border-t border-[#C5A059]/10 relative z-10 bg-[#F8FAFC]">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-end">
            <div className="md:col-span-8">
              ...
              <div className="text-3xl md:text-4xl lg:text-[48px] font-serif italic font-light opacity-10 leading-none text-[#C5A059]">EDEN.AI</div>
            </div>

            <div className="md:col-span-4 flex flex-col items-start md:items-end">
              <div className="flex items-center gap-3 mb-4">
                <Link to="/Portfolio" className="flex items-center gap-2 text-[10px] uppercase tracking-widest text-gray-600 hover:text-[#C5A059] transition-all">
                  <ArrowLeft size={14} /> Back to Portfolio
                </Link>
              </div>
              <div className="text-[10px] uppercase tracking-[0.2em] text-gray-500 text-right">
                Manifest Authority &copy; 2024 / flint_sol<br/>
                optimized_creative_systems
              </div>
              <div className="flex gap-4 mt-4">
                <div className="w-10 h-[1px] bg-[#C5A059]"></div>
                <div className="w-2 h-[1px] bg-[#C5A059] opacity-30"></div>
              </div>
            </div>
          </div>
        </div>
